...
st.set_page_config(page_title="Trending Skills", layout="wide")
...
try:
    df_trending_skills = pd.read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vSciotZEMPUqnyLbEwFRZSOy4r6-2L7eKjkm4IvBW8pC6tVhzmBFM08jTIqVzVfn7klNfJEFpYV5oxz/pub?output=csv")
...
st.dataframe(df_trending_skills)

# Visualization: Trending skills in a bar chart
st.write("### Visualization of Trending Skills:")
st.bar_chart(df_trending_skills.set_index("Skill")["Occurrences"])
